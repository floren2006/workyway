<div class="container-fluid py-4">
    ...
    <div class="d-flex align-items-center mb-4">
        <a href="<?= base_url('penilaian'); ?>" class="btn btn-outline-secondary me-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <?php if ($pengumpulan['file_template']): ?>
                    <div class="mb-3">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title mb-3">File Jawaban</h5>
                    ...
                    <div class="alert alert-light border mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="<?= base_url('penilaian/download_file/' . $pengumpulan['pengumpulan_id']); ?>" 
                    ...
                    <?php if (!$pengumpulan['file_tugas'] && !$pengumpulan['link_pengumpulan']): ?>
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        Tidak ada file atau link pengumpulan
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <!-- Feedback Sebelumnya -->
            <?php if ($pengumpulan['feedback'] && $pengumpulan['status'] == 'dinilai'): ?>
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title mb-3">Feedback Sebelumnya</h5>
                    <div class="alert alert-success">
                        <?= nl2br(htmlspecialchars($pengumpulan['feedback'])); ?>
                        <div class="text-muted mt-2">
                            <small>Nilai: <?= $pengumpulan['nilai']; ?>/100</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-3">Berikan Penilaian</h5>
                    
                    <?= form_open('penilaian/simpan_nilai', array('id' => 'form-nilai')); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Nilai maksimum: <?= $pengumpulan['max_score']; ?></div>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Feedback untuk Siswa</label>
                            <textarea name="feedback" class="form-control" rows="4" 
                                      placeholder="Berikan feedback yang konstruktif..."><?= $pengumpulan['feedback'] ?? ''; ?></textarea>
                        </div>
                        
                        <div class="mb-3 form-check">
                            <input type="checkbox" name="notifikasi" class="form-check-input" id="notif" checked>
                            <label class="form-check-label" for="notif">Kirim notifikasi ke siswa</label>
                        </div>
                        
                        <div class="d-grid gap-2">
                            <a href="<?= base_url('penilaian'); ?>" class="btn btn-outline-secondary">Batal</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="alert alert-success">
                        <h5><i class="fas fa-check-circle me-2"></i> Sudah Dinilai</h5>
                        <div class="mt-3">
                    ...
                    <div class="d-grid">
                        <a href="<?= base_url('penilaian'); ?>" class="btn btn-outline-primary">
